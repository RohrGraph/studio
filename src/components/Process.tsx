    ...
    <section aria-labelledby="process-headline">
      <div className="container">
        <div className="mx-auto max-w-3xl text-center">
          <h2 id="process-headline">In 4 Schritten zu Ihrer neuen Website</h2>
          <p className="mt-4 text-lg text-muted-foreground">
            Unser Prozess ist einfach, transparent und darauf ausgelegt, Sie schnell und ohne Aufwand online zu bringen.
          </p>
        </div>
